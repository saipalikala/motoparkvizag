...
const TrendCard = ({ product }) => {
    ...
    return (
        <div className="trend-card" onClick={handleCardClick} role="button" tabIndex={0}
            ...
            {/* BADGE */}
            {categoryLabel && (
                <span className="trend-badge">{categoryLabel}</span>
            )}

            {/* IMAGE */}
            <div className="trend-image-wrap">
                {image
                    ? <img src={image} alt={product.name} className="trend-img" />
